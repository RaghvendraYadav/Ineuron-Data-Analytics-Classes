...
# Seprate the Data and lok into the Specific Record
# Store a data internally Year Wise
# Partition using Range
...
select * from ineuron_course1 where course_launch_year=2020;# partition Takes less time 
select * from ineuron_course where course_launch_year=2020;# this take more time to execute
...
# Partition is Done on Year column 2019%5= 2020 %5 so the remainder we get it will go there only 
# Hash Partition means Year%total no of partition then it will go to the remainder indexx 2020%5 =0 so it will go to P0 partition

# Key Partition  it also use another Hashing Algorithm MD5()
